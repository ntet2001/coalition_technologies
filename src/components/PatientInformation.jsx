...
const PatientInformation = ({ patient }) => {
  ...
  const patientBirthday = patient.date_of_birth;
  const patientGender = patient.gender;
  const patientContact = patient.phone_number;
  const patientEmergencyContact = patient.emergency_contact;
  const patientInsuranceProvider = patient.insurance_type;
